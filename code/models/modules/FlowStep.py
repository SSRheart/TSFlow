...
class FlowStep(nn.Module):
    ...
    def __init__(self, in_channels, hidden_channels,
        ...
        # 3. coupling
        # if self.flow_coupling == 'cond':

        # self.affine = models.modules.FlowAffineCouplingsAblation_global.CondAffineSeparatedAndCond_globalfeature(in_channels=in_channels,
                                                                                            # opt=opt)
        # elif self.flow_coupling == 'nocond':
        #     self.affine = models.modules.FlowAffineCouplingsAblation.CondAffineSeparated_globalfeature(in_channels=in_channels,
        #                                                                                         opt=opt)

        # elif self.flow_coupling == 'denoise':
        #     self.affine = models.modules.FlowAffineCouplingsAblation.CondAffineSeparatedAndCondAndDenoise_globalfeature(in_channels=in_channels,
        #                                                                                         opt=opt)
        elif self.flow_coupling == 'norm':
            self.affine = models.modules.FlowAffineCouplingsAblation.CondAffineSeparatedAndCond_globalfeaturenorm(in_channels=in_channels,
                                                                                                opt=opt)
        elif self.flow_coupling == 'affine':
            self.affine = models.modules.FlowAffineCouplingsAblation.AffineSeparated(in_channels=in_channels,
                                                                                                opt=opt)
